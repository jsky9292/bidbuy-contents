...
function getConfig() {
  ...
  if (isServerless || !fs) {
    return {
      ...
      site_url: process.env.NEXT_PUBLIC_SITE_URL || 'https://youtubeblog-rho.vercel.app',
      min_views: 10000,
      max_results: 20,
  ...
  try {
    ...
    return {
      ...
      google_maps_api_key: process.env.GOOGLE_MAPS_API_KEY || config.google_maps_api_key || '',
